...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x10 modulator_wave W 0x0 "Data signal of modulator_wave" {{0 32 modulator_wave W 0 "Bit 31 to 0 Data signal of modulator_wave"}}} {0x18 modulator_phase W 0x0 "Data signal of modulator_phase" {{0 32 modulator_phase W 0 "Bit 31 to 0 Data signal of modulator_phase"}}} {0x20 scale_factor W 0x0 "Data signal of scale_factor" {{0 32 scale_factor W 0 "Bit 31 to 0 Data signal of scale_factor"}}} {0x28 carrier_wave W 0x0 "Data signal of carrier_wave" {{0 32 carrier_wave W 0 "Bit 31 to 0 Data signal of carrier_wave"}}} {0x30 carrier_phase W 0x0 "Data signal of carrier_phase" {{0 32 carrier_phase W 0 "Bit 31 to 0 Data signal of carrier_phase"}}} {0x38 sync W 0x0 "Data signal of sync" {{0 32 sync W 0 "Bit 31 to 0 Data signal of sync"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_BUS result_V newNote_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
set enable_xo_gen 0
set kernel_files {/home/austin/FMgit/FMSYNTH/hls_module/HLS_FMSYNTH.cpp}
if {$enable_xo_gen} {
