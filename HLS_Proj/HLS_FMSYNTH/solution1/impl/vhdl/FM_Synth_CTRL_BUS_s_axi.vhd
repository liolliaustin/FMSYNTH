            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_MODULATOR_PHASE_DATA_0 =>
                        rdata_data <= RESIZE(int_modulator_phase(31 downto 0), 32);
                    when ADDR_SCALE_FACTOR_DATA_0 =>
                        rdata_data <= RESIZE(int_scale_factor(31 downto 0), 32);
                    when ADDR_CARRIER_WAVE_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MODULATOR_WAVE_DATA_0) then
                    int_modulator_wave(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_modulator_wave(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MODULATOR_PHASE_DATA_0) then
                    int_modulator_phase(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_modulator_phase(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CARRIER_WAVE_DATA_0) then
                    int_carrier_wave(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_carrier_wave(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CARRIER_PHASE_DATA_0) then
                    int_carrier_phase(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_carrier_phase(31 downto 0));
                end if;
            end if;
        end if;
    end process;
