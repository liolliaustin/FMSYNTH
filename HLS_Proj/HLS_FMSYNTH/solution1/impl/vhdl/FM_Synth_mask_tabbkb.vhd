...
entity FM_Synth_mask_tabbkb_rom is 
    generic(
             dwidth     : integer := 52; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of FM_Synth_mask_tabbkb_rom is 
...
entity FM_Synth_mask_tabbkb is
    generic (
...
architecture arch of FM_Synth_mask_tabbkb is
    component FM_Synth_mask_tabbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    FM_Synth_mask_tabbkb_rom_U :  component FM_Synth_mask_tabbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
