...
#ifndef __FM_Synth_sitofp_3g8j__HH__
#define __FM_Synth_sitofp_3g8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(FM_Synth_sitofp_3g8j) {
    ...
    SC_CTOR(FM_Synth_sitofp_3g8j):  ACMP_sitofp_U ("ACMP_sitofp_U") {
