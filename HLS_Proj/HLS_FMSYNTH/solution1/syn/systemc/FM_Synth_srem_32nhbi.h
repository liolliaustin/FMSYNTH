...
#ifndef __FM_Synth_srem_32nhbi__HH__
#define __FM_Synth_srem_32nhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FM_Synth_srem_32nhbi) {
    ...
    SC_CTOR(FM_Synth_srem_32nhbi):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
