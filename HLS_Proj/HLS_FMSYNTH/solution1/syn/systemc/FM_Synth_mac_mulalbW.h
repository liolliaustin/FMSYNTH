...
#ifndef __FM_Synth_mac_mulalbW__HH__
#define __FM_Synth_mac_mulalbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FM_Synth_mac_mulalbW) {
    ...
    SC_CTOR(FM_Synth_mac_mulalbW):  simcore_mac_0_U ("simcore_mac_0_U") {
