...
#ifndef __FM_Synth_sitofp_3fYi__HH__
#define __FM_Synth_sitofp_3fYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(FM_Synth_sitofp_3fYi) {
    ...
    SC_CTOR(FM_Synth_sitofp_3fYi):  ACMP_sitofp_U ("ACMP_sitofp_U") {
