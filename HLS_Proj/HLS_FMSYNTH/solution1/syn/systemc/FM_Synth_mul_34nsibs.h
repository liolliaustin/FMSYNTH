...
#ifndef __FM_Synth_mul_34nsibs__HH__
#define __FM_Synth_mul_34nsibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FM_Synth_mul_34nsibs) {
    ...
    SC_CTOR(FM_Synth_mul_34nsibs):  ACMP_mul_us_U ("ACMP_mul_us_U") {
