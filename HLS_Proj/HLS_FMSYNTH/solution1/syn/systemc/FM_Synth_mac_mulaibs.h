...
#ifndef __FM_Synth_mac_mulaibs__HH__
#define __FM_Synth_mac_mulaibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FM_Synth_mac_mulaibs) {
    ...
    SC_CTOR(FM_Synth_mac_mulaibs):  simcore_mac_0_U ("simcore_mac_0_U") {
