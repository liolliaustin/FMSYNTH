...
#ifndef __FM_Synth_mul_34nshbi__HH__
#define __FM_Synth_mul_34nshbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FM_Synth_mul_34nshbi) {
    ...
    SC_CTOR(FM_Synth_mul_34nshbi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
