...
#ifndef __FM_Synth_mul_32s_lbW__HH__
#define __FM_Synth_mul_32s_lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FM_Synth_mul_32s_lbW) {
    ...
    SC_CTOR(FM_Synth_mul_32s_lbW):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
