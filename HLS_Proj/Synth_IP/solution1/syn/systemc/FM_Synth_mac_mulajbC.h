...
#ifndef __FM_Synth_mac_mulajbC__HH__
#define __FM_Synth_mac_mulajbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FM_Synth_mac_mulajbC) {
    ...
    SC_CTOR(FM_Synth_mac_mulajbC):  simcore_mac_0_U ("simcore_mac_0_U") {
